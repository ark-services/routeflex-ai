  ...
  return (
    <div className="space-y-6">
      ...
      {success === 'gmail_connected' && (
        <div className="bg-green-50 border border-green-200 rounded-lg p-4 flex items-start gap-3">
          ...
          <div>
            ...
            {connectedEmail && (
              <p className="text-xs text-green-700 mt-1">Connected as {connectedEmail}</p>
            )}
          </div>
        </div>
      )}
      ...
      <div>
        ...
        <p className="text-sm text-stone-600 mt-1">Connect your accounts to use in automations</p>
      </div>
