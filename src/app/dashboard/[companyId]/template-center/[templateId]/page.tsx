  ...
  return (
    <div className="h-full overflow-auto">
      ...
      <div className="border-b border-stone-200 bg-white px-6 py-3 flex items-center gap-3">
        ...
        <span className="text-sm text-stone-700 truncate max-w-xs">{template.title}</span>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="flex-1 min-w-0">
            {/* Thumbnail */}
            <div className="w-full h-52 rounded-xl overflow-hidden mb-6 bg-stone-100">
              <TemplateThumbnail
            ...
            {/* Title */}
            <h1 className="text-2xl font-bold text-stone-900">{template.title}</h1>
            ...
            {template.description && (
              <p className="mt-5 text-stone-600 leading-relaxed">{template.description}</p>
            )}
              ...
              <div className="mt-6">
                ...
                <div className="space-y-2">
                  {template.payload.groups.map((g, i) => (
                    <div
                      key={i}
                      className="flex items-center gap-3 px-3 py-2 bg-stone-50 rounded-lg border border-stone-100"
                    >
                      <div
