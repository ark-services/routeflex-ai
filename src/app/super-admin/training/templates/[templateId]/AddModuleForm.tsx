...
import { createTemplateModule } from "../actions";
...
export function AddModuleForm({ templateId, isFinalExam }: Props) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setError(null);
    try {
      const moduleId = await createTemplateModule(templateId, {
        title,
        content: "",
      ...
      setTitle("");
      setOpen(false);
      router.push(`/super-admin/training/templates/${templateId}/modules/${moduleId}`);
    } catch (err: any) {
