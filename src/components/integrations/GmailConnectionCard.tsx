  ...
  return (
    <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg hover:border-gray-300 transition-colors bg-rf-surface-card">
      ...
      <button
        ...
        disabled={loading}
        className="px-3 py-1.5 text-xs text-rf-danger hover:bg-rf-danger-bg rounded border border-red-200 hover:border-red-300 transition-colors disabled:opacity-50 flex items-center gap-1"
      >
